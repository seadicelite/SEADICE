...
final _defaultApps = [
  ...
  AppItem(
    ...
    title: 'キャンプ持ち物マスター',
    tag: 'Productivity',
    desc: 'カテゴリ別チェックリストでキャンプの忘れ物をゼロにする準備管理アプリ。',
    color: const Color(0xFF00FFD1),
    icon: 'キャ',
    webUrl: 'https://seadice.win/apps/camping_app1/',
    status: 'MINI',
  ),
  AppItem(
    id: 22,
    title: 'キャンプ日記トラッカー',
    tag: 'Lifestyle',
    desc: 'キャンプ場・天気・料理・感想を記録するデジタルキャンプ日記アプリ。',
    color: const Color(0xFF10A37F),
    icon: 'キャ',
    webUrl: 'https://seadice.win/apps/camping_app2/',
    status: 'MINI',
  ),
  AppItem(
    id: 23,
    title: 'キャンプマナークイズ',
    tag: 'Education',
    desc: 'キャンプマナーと安全知識を100問以上のクイズで楽しく学ぶ教育アプリ。',
    color: const Color(0xFF3B82F6),
    icon: 'キャ',
    webUrl: 'https://seadice.win/apps/camping_app3/',
    status: 'MINI',
  ),
  AppItem(
    id: 14,
