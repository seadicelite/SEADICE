...
### 1. 冒頭に「明確な結論」を書く（PREP法）

記事の最初の1〜2文で結論を述べる。AI はユーザーの質問に対して冒頭の答えを引用しやすい。

```
悪い例: 「家庭菜園を始めるにあたって、まず考えるべきことは...」
良い例: 「家庭菜園の土作りは、腐葉土と堆肥を混ぜた水はけの良い培養土が基本です。」
```

- h1 の直後、最初の `<p>` で「〇〇とは、▲▲のことです」と結論を置く
- その後 h2 以降で詳しい理由・手順・背景を展開する
